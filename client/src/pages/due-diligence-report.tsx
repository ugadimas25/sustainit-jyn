...
export default function DueDiligenceReport() {
  ...
  const handleDdsSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const ddsData: InsertDdsReport = {
      ...
      totalProducers: formData.get('totalProducers') ? parseInt(formData.get('totalProducers') as string).toString() : undefined,
      totalPlots: formData.get('totalPlots') ? parseInt(formData.get('totalPlots') as string).toString() : undefined,
      ...
      maxIntermediaries: formData.get('maxIntermediaries') ? parseInt(formData.get('maxIntermediaries') as string).toString() : undefined,
